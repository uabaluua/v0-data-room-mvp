...
import { DataRoomProvider, useDataRoom } from "@/lib/data-room-context"
...
// Helper function to create a data URL for PDF viewing
function createDataUrl(base64Data: string, mimeType: string = "application/pdf"): string {
        ...
        <Card className="max-w-md">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-muted-foreground mb-4">{error || "This share link is invalid or has been removed."}</p>
